...
export type AISecurityEvent =
  ...
  | 'WHATSAPP_UNREGISTERED_IDENTITY'
  | 'WHATSAPP_IDOR_BLOCKED'
  | 'WHATSAPP_PROMPT_INJECTION_BLOCKED'
  | 'WHATSAPP_TOOL_DENIED'
  | 'WHATSAPP_MUTATION_PREVIEW'
  | 'WHATSAPP_MUTATION_CONFIRMED'
  | 'WHATSAPP_MUTATION_BLOCKED'
