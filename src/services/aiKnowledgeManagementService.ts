...
const INITIAL_KNOWLEDGE_DOCUMENTS: DocumentMetadata[] = [
  // 1. AD_ART (v1.0 SUPERSEDED, v1.2 ACTIVE)
  {
    ...
    approvedBy: 'Eko Sucahyono (Ketua RT 2024)',
    uploadedBy: 'ADMIN',
    ...
    language: 'id',
    tags: ['ad_art', 'organisasi', 'hak_warga', 'kewajiban', 'iuran', 'iuran_35rb', '2024'],
    priority: 2,
    visibility: 'PUBLIC',
  ...
  },
  {
    ...
    approvedBy: 'Eko Sucahyono (Ketua RT 07)',
    uploadedBy: 'ADMIN',
    ...
    language: 'id',
    tags: ['ad_art', 'organisasi', 'hak_warga', 'kewajiban', 'iuran', 'iuran_50rb', 'kas_warga'],
    priority: 2,
    visibility: 'PUBLIC',
  ...
  // 6. KONTAK (v1.1 ACTIVE)
  {
    ...
    priority: 6,
    visibility: 'PUBLIC',
    content: 'Kontak Resmi RT 07: Ketua RT: Bapak Eko Sucahyono | Email: rt07rw11.gpa@gmail.com | Jam Sekretariat: 18:30 - 21:00 WIB.',
...
const INITIAL_RELEASES: KnowledgeRelease[] = [
  {
    ...
    releasedBy: 'ADMIN (Eko Sucahyono)',
