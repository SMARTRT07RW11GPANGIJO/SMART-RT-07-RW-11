...
export const AUDIT_EVENTS = {
  ...
  // Registration & SSoT (CR-SMART-RT-REG-AUTH-001)
  REGISTRATION_SSOT_WRITE_ATTEMPTED: 'REGISTRATION_SSOT_WRITE_ATTEMPTED',
  REGISTRATION_SSOT_WRITE_CONFIRMED: 'REGISTRATION_SSOT_WRITE_CONFIRMED',
  REGISTRATION_SSOT_WRITE_FAILED: 'REGISTRATION_SSOT_WRITE_FAILED',
  WARGA_REGISTRATION_PERSISTED: 'WARGA_REGISTRATION_PERSISTED',
  KELUARGA_REGISTRATION_PERSISTED: 'KELUARGA_REGISTRATION_PERSISTED',
  AUTH_ACCOUNT_PROVISIONED: 'AUTH_ACCOUNT_PROVISIONED',
  CONSENT_SUBMITTED: 'CONSENT_SUBMITTED',
  WARGA_VERIFIED: 'WARGA_VERIFIED',
  WARGA_REJECTED: 'WARGA_REJECTED',
  KELUARGA_VERIFIED: 'KELUARGA_VERIFIED',
  KELUARGA_REJECTED: 'KELUARGA_REJECTED'
} as const;
